export const platformProfiles = {
  ...
  substack: {
    ...
    bestFormats: ["newsletter", "founder note", "roundup", "essay"],
    structureRules: [
      "Lead with the point or premise quickly.",
      "Write in paragraphs that work in email as well as web.",
      "Give the reader a reason to come back next post.",
    ],
    ctaStyle: "Subscribe, reply, read more, or click through.",
    linkTolerance: "high",
    emojiTolerance: "low",
    humorTolerance: "medium",
    ...
    openerPatterns: [
      ...
      "A strong first paragraph that promises a payoff",
    ],
    notes: ["Closer to an email-backed publication than a social feed."],
    sourceNotes: ["Substack publishing and Notes norms."],
  },
  reddit: {
    id: "reddit",
    label: "Reddit",
